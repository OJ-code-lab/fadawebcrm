...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        "font-heading text-2xl leading-6 font-semibold  [&:not(:has(~[data-slot=questionnaire-description]))]:mb-4",
        className,
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      <QuestionnairePrimitive.Input
        ...
        className={cn(
          "h-8 min-h-11 w-full min-w-0 rounded-3xl border border-gray-50/20 bg-gray-100/80 px-2.5 py-5 text-base transition-[color,box-shadow,background-color] outline-none focus-visible:border-gray-50 focus-visible:ring focus-visible:ring-ring/20 disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-input/20 disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring aria-invalid:ring-destructive/20 sm:min-h-0 md:text-sm dark:bg-input/30 dark:disabled:bg-input/80 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40",
