...
export default function Step2CLocation({
  value,
  onChange,
  onExplain,
}: Step2CLocationProps) {
  ...
  return (
    <div className="text-center flex flex-col justify-center items-center">
      ...
      {/* Question */}
      <h2 className="mt-5 text-[21px] font-bold leading-[1.2] text-[#080808] sm:text-2xl">
        What state will you be operating from?
      </h2>

      {/* Explanation */}
      <p className="mx-auto mt-4 max-w-[420px] text-[14px] leading-5 text-[#6f7280]">
        We strongly recommend Wyoming to owners that are located outside of the
        US.
      </p>

      {/* State selector */}
      <div className="relative mt-7 w-full lg:w-130">
        <button
          type="button"
